...
- 推敲の観点（`writing-principles`）。追記した文を前後と一続きで読めるように整え、弁明調を排し、内容に応じて文・箇条書き・表を選択する方針を定める。意味、事実関係、規範の強度、コード、コマンド、識別子を変更せず平易なビジネス文書の日本語に修正し、用語を変更した際は推敲の対象範囲外の同一用語も一括して改める
